...
void initialize_gdextension_types(ModuleInitializationLevel p_level)
{
	...
	GDREGISTER_ABSTRACT_CLASS(SynthResource)
	GDREGISTER_CLASS(SynthModulationChannel)
	GDREGISTER_ABSTRACT_CLASS(SynthParameterSource)
	GDREGISTER_CLASS(SynthParameterCombiner)
	GDREGISTER_CLASS(SynthConstantParameter)
	GDREGISTER_CLASS(SynthADSR)
	GDREGISTER_CLASS(SynthLFO)
	GDREGISTER_CLASS(SynthModulationReceiver)
	...
	GDREGISTER_ABSTRACT_CLASS(SynthFrequencyFilter)
	GDREGISTER_CLASS(SynthDCBlockFilter)
	GDREGISTER_CLASS(SynthChorusFilter)
